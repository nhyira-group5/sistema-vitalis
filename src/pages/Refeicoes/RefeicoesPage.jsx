            ...
            <div className="w-[90vw] h-full flex flex-col">
                ...
                <div className="flex flex-col gap-3 p-5">
                    ...
                    <div className="w-1/3">
                        ...
                        inputStyle={'group-focus-within:!ring-primary-green300 h-13 px-5 relative flex w-full border-gray100 border-2 rounded-full outline-none ring-1 ring-gray500'}
