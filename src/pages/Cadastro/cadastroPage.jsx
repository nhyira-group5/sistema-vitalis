...
export function CadastroPage() {
  ...
  return (
    <>
      <div
        className={`relative flex w-screen h-screen bg-gray500 transition-all duration-500 ease-in-out`}
      >
        <SideCard
          ...
          userType={userType}
          style={`absolute transition-all duration-500 ease-in-out transform  ${
            userType ? '-translate-x-5' : 'translate-x-[70vw]'
          } z-50`}
          Button={
            <Button
              ...
              } rounded-full font-bold px-5 py-4 transition-all flex items-center gap-1 text-gray100 `}
            />
          }
        />

        <div
          className={`flex flex-col gap-6 text-gray100 py-10 px-14 w-2/3 h-full transition-all duration-500 ease-in-out absolute transform  ${
            userType ? 'translate-x-[33vw]' : 'translate-x-2'
          }`}
        >
