...
import { validateNome, validateSenha, validateUsername, validateConfSenha, validateEmail, validateIdade, validateCPF, validateCEP} from "@utils/validacoes";
import { User, PencilSimpleLine, EnvelopeSimple, Lock, CalendarDots, Hash, MapPinArea, ArrowLeft, ArrowRight } from "@phosphor-icons/react";
...
export function InstrutorFormCadastro() {
    ...
    <>
    <form onSubmit={handleFirstSubmit} className={` grid-cols-2 grid-rows-5 gap-3 gap-x-16 h-full ${formStep == 1 ? 'grid' : 'hidden'}`}>
            <Input labelContent={"Nome do usuário"}

                labelStyle = {"group-focus-within:text-alt-purple300 text-lg font-bold pl-[8%]"}
                inputStyle={"group-focus-within:!ring-alt-purple300  h-16 p-3  relative flex w-full  bg-gray100 border-gray100 border-2 rounded-full outline-none ring-1 ring-gray500"}
                separatorStyle={"group-focus-within:!bg-alt-purple300 bg-gray500 data-[orientation=vertical]:w-[1.1px] h-full rounded-full mx-[10px]"}
            ...
            <Select options={["Masculino", "Feminino"]}
                    ...
                    labelStyle = {"group-focus-within:text-alt-purple300 text-lg font-bold pl-[8%]"}
                    selectStyle={"group-focus-within:!ring-alt-purple300  h-16 p-3  relative flex w-full  bg-gray100 border-gray100 border-2 rounded-full outline-none ring-1 ring-gray500"}
            ...
            <Button content={"Continuar"}
                    ...
                    buttonStyle={"text-gray100 bg-alt-purple300 rounded-full font-bold px-5 py-4 hover:bg-alt-purple400 transition-all flex items-center gap-1 flex-row-reverse justify-center w-[16rem]"}
                    icon={<ArrowRight/>}
                    />
            </fieldset>
    </form>

    <form onSubmit={handleSecondSubmit} className= {`grid-cols-2 grid-rows-5 gap-3 gap-x-16 h-full ${formStep == 2 ? 'grid' : 'hidden'}`} >
            <Input labelContent={"CEP"}
            ...
            <Input labelContent={"Rua/Logradouro"}
                icon={<MapPinArea size={32} color='#000000'/>}
            ...
            <fieldset className=' grid justify-end items-start'>
                <Button content={"Voltar"}
                        ...
                        buttonStyle={"text-gray100 bg-gray300 rounded-full font-bold px-5 py-4 hover:bg-gray400 transition-all flex items-center gap-1 w-[16rem] justify-center"}
                        icon={<ArrowLeft/>}
                        />
            </fieldset>
            ...
            <fieldset className=' grid justify-start items-start'>
                <Button content={"Criar conta"}
                        type={"submit"}
                        buttonStyle={"text-gray100 bg-alt-purple300 rounded-full font-bold px-5 py-4 hover:bg-alt-purple400 transition-all flex items-center gap-1 w-[16rem] justify-center"}
